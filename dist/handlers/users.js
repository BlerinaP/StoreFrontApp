...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                newUser = _a.sent();
                token = jwt.sign({ user: newUser }, process.env.BCRYPT_PASSWORD);
                res.json(token);
                return [3 /*break*/, 3];
            case 2:
                err_2 = _a.sent();
...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.authenticate(user.firstname, user.password)];
            case 2:
                u = _a.sent();
                token = jwt.sign({ user: u }, process.env.BCRYPT_PASSWORD);
                res.json(token);
                return [3 /*break*/, 4];
            case 3:
                err_6 = _a.sent();
